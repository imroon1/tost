...
import stripe
STRIPE_SECRET_KEY = getattr(settings, "STRIPE_SECRET_KEY", "sk_test_oUaMQz3zPHNXDq566WMIRLAR")
STRIPE_PUB_KEY = getattr(settings, "STRIPE_PUB_KEY",'pk_test_IwXUGyFvPIQFjoVEGDCj6bx7')
stripe.api_key = STRIPE_SECRET_KEY

# https://github.com/codingforentrepreneurs/eCommerce/tree/master/src/billing
